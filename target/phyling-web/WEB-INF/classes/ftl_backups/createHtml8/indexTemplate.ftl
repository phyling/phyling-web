...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="template/static_8/css/bootstrap.css" rel="stylesheet">
    <!-- Add custom CSS here -->
    <link href="template/static_8/css/slidefolio.css" rel="stylesheet">
	<!-- Font Awesome -->
    <link href="template/static_8/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <style type="text/css">
...
<!-- /Load Photo in Modal -->	
    ...
    <script src="template/static_8/js/jquery.js"></script>
	<script src="template/static_8/js/jquery-scrolltofixed-min.js"></script>
	<script src="template/static_8/js/jquery.vegas.js"></script>
	<script src="template/static_8/js/jquery.mixitup.min.js"></script>
	<script src="template/static_8/js/jquery.validate.min.js"></script>
	<script src="template/static_8/js/script.js"></script>
	<script src="template/static_8/js/bootstrap.js"></script>
...
src:'template/static_8/img/overlay.png'
});
