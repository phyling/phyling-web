package com.phyling.controller.${packageName}.${objectNameLower};
...
import com.phyling.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.phyling.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
