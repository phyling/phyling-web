...
<link rel="stylesheet" href="template/static_6/bootstrap/css/bootstrap.min.css">
<!-- Font Awesome CSS -->
<link rel="stylesheet" href="template/static_6/fonts/font-awesome.min.css">
<!-- venobox -->
<link rel="stylesheet" href="template/static_6/venobox/css/venobox.css" />
<!--- owl carousel Css-->
<link rel="stylesheet" href="template/static_6/owlcarousel/css/owl.carousel.css">
<link rel="stylesheet" href="template/static_6/owlcarousel/css/owl.theme.css">
<!-- animate CSS -->		
<link rel="stylesheet" href="template/static_6/css/animate.css">
<!-- Style CSS -->
<link rel="stylesheet" href="template/static_6/css/style.css">
<!-- CSS FOR COLOR SWITCHER -->
<link rel="stylesheet" href="template/static_6/css/switcher/switcher.css">
<link rel="stylesheet" href="template/static_6/css/switcher/style1.css" id="colors">
...
<!-- START SERVICES -->
<section id="service" class="our_services section-padding" style="background-image: url(template/static_6/img/bg/service-bg.jpg); background-size:cover; background-position: center center;background-attachment:fixed">
<div class="container">
	<div class="row text-center">
		<div class="section-title text-center wow zoomIn">
...
<!-- START CONTACT -->
<section id="contact" class="contact_area section-padding" style="background-image: url(template/static_6/img/bg/contact-bg.jpg); background-size:cover; background-position: center center;background-attachment:fixed">
<div class="container">				
	<div class="row">
		<div class="section-title text-center wow zoomIn">
...
<!-- Latest jQuery -->
<script src="template/static_6/js/jquery-1.12.4.min.js"></script>
<!-- Latest compiled and minified Bootstrap -->
<script src="template/static_6/bootstrap/js/bootstrap.min.js"></script>
<!-- modernizer JS -->		
<script src="template/static_6/js/modernizr-2.8.3.min.js"></script>
<!-- venobox js -->
<script src="template/static_6/venobox/js/venobox.min.js"></script>
<!-- jquery appear js  -->
<script src="template/static_6/js/jquery.appear.js"></script>
<!-- countTo js -->
<script src="template/static_6/js/jquery.inview.min.js"></script>
<!-- jquery mixitup js -->
<script src="template/static_6/js/jquery.mixitup.js"></script>
<!-- owl-carousel min js  -->
<script src="template/static_6/owlcarousel/js/owl.carousel.min.js"></script>
<!-- scrolltopcontrol js -->
<script src="template/static_6/js/scrolltopcontrol.js"></script>
<!-- WOW - Reveal Animations When You Scroll -->
<script src="template/static_6/js/wow.min.js"></script>
<!-- form-contact js -->
<script src="template/static_6/js/form-contact.js"></script>
<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDwIQh7LGryQdDDi-A603lR8NqiF3R_ycA"></script>--->
<!-- switcher js -->
<script src="template/static_6/js/switcher.js"></script>
<!-- scripts js -->
<script src="template/static_6/js/scripts.js"></script>
