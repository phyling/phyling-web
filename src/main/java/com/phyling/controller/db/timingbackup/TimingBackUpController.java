package com.phyling.controller.db.timingbackup;
...
public class TimingBackUpController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("phyling/timingbackup/timingbackup_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("phyling/timingbackup/timingbackup_edit");
